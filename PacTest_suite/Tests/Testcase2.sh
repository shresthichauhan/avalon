...
function printDesc {
echo -e "\e[45m===============================================\e[0m"
echo 'Description: Script to check latest SDPTool uninstallion work as expected'
...
function dopreconfiguration {
	echo 'Install new SDPTool-1.3-11 package'
...
function validation {
	...
	if [  "$ValResult" -eq '0' ]; then
		echo -e "\e[45m===============================================\e[0m"
		echo 'SDPTool packages uninstalled successfully.'
		printPass
		echo -e "\e[45m===============================================\e[0m"
	else
		printFail
