...
function printDesc {
echo '----------------------------------'
echo 'Description: Script to update a latest SDPTool, when noting is installed'
...
echo 'Expected Result : SPDTool is not installed. Nothing to update ..  Exiting'
echo '----------------------------------'
}
...
function testcase {
	# Testcase 20 let's update the latest SDPTool
...
function validation {
	...
	if [  "$ValResult" -eq '1' ]; then
		echo -e "\e[45m===============================================\e[0m"
		echo 'SPDTool is not installed. Nothing to update ..  Exiting.'
		printPass
		echo -e "\e[45m===============================================\e[0m"
	else
		printFail
