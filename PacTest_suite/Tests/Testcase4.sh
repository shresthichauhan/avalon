...
function printDesc {
echo -e "\e[45m===============================================\e[0m"
echo 'Description: Script for installing packages twice and then uninstall the SDPTool'
...
echo -e '\t\t5. run sdptool_uninstall.sh'
echo 'Expected Result : SDPTool packages should uninstall smoothly after installing twice.'
echo -e "\e[45m===============================================\e[0m"
}
...
function validation {
	...
	if [  "$ValResult" -eq '010' ]; then
		echo -e "\e[45m===============================================\e[0m"
		echo 'First SDPTool install properly, second install completes with already installed response and then uninstall successfully.'
		printPass
		echo -e "\e[45m===============================================\e[0m"
	else
		printFail
