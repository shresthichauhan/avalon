...
function printDesc {
echo '----------------------------------'
echo 'Description: Script to Install latest package and update'
...
echo -e '\t\t4. run sdptool_update.sh'
echo 'Expected Result : Current version (latest) is already installed. Nothing to update .. Exiting'
echo '----------------------------------'
}
...
function testcase {
    # Testcase 8 lets's install the SDPTool
...
function validation {
	...
	if [  "$ValResult" -eq '01' ]; then
		echo -e "\e[45m===============================================\e[0m"
		echo 'Current version (latest) is already installed. Nothing to update .. Exiting.'
		printPass
		echo -e "\e[45m===============================================\e[0m"
	else
		printFail
