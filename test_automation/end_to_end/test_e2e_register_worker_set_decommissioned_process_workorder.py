...
def test_e2e_register_worker_set_decommissioned_process_workorder(setup_config):
    ...
    # input_json_file = r'./end_to_end/input/e2e_register_worker_set_decommissioned_process_workorder_01.json'
    # output_json_file_name = 'e2e_register_worker_set_decommissioned_process_workorder_01'
    # id_gen_01 = True
    # # expected response
    ...
    # if err_cd == 0:
    #     # input and output names
    #     input_json_file_02 = r'./end_to_end/input/e2e_register_worker_set_decommissioned_process_workorder_02.json'
    #     output_json_file_name_02 = 'e2e_register_worker_set_decommissioned_process_workorder_02'
    #     id_gen_02 = False
    #     # expected response
    ...
    if err_cd == 0:
        # input and output names
        input_json_file_03 = r'./end_to_end/input/e2e_register_worker_set_decommissioned_process_workorder_03.json'
        output_json_file_name_03 = 'e2e_register_worker_set_decommissioned_process_workorder_03'
        id_gen_03 = False
        # expected response
    ...
    if err_cd == 0:
        # input and output names
        input_json_file_04 = r'./end_to_end/input/e2e_register_worker_set_decommissioned_process_workorder_04.json'
        output_json_file_name_04 = 'e2e_register_worker_set_decommissioned_process_workorder_04'
        input_type_04 = 'file'

        # expected response
        check_submit_04 = {"error": {"code": 5}}
        check_get_result_04 = {"error": {"code": 3}}
        tamper = {"params": {}}
