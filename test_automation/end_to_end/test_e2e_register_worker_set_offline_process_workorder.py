...
def test_e2e_register_worker_set_offline_process_workorder(setup_config):
    ...
    # input_json_file = r'./end_to_end/input/e2e_register_worker_set_offline_process_workorder_01.json'
    # output_json_file_name = 'e2e_register_worker_set_offline_process_workorder_01'
    # id_gen_01 = True
    # # expected response
    ...
    # if err_cd == 0:
    #     # input and output names
    #     input_json_file_02 = r'./end_to_end/input/e2e_register_worker_set_offline_process_workorder_02.json'
    #     output_json_file_name_02 = 'e2e_register_worker_set_offline_process_workorder_02'
    #     id_gen_02 = False
    #     # expected response
    ...
    #     logger.info("ERROR: Response : %s \n", response)
    #     worker_obj.load_worker(response)
    #     logger.info("ERROR: worker_id : %s \n", worker_obj.worker_id)
    if err_cd == 0:
        # input and output names
        input_json_file_03 = r'./end_to_end/input/e2e_register_worker_set_offline_process_workorder_03.json'
        output_json_file_name_03 = 'e2e_register_worker_set_offline_process_workorder_03'
        id_gen_03 = False
        # expected response
    ...
    if err_cd == 0:
        # input and output names
        input_json_file_04 = r'./end_to_end/input/e2e_register_worker_set_offline_process_workorder_04.json'
        output_json_file_name_04 = 'e2e_register_worker_set_offline_process_workorder_04'
        input_type_04 = 'file'
