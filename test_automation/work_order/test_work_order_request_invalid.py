...
def test_work_order_request_invalid(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_request_invalid.json'
    input_type = 'file'
    output_json_file_name = 'work_order_request_invalid'
