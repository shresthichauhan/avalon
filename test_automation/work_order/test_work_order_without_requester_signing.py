...
def test_work_order_without_requester_signing(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_without_requester_signing.json'
    input_type = 'file'
    output_json_file_name = 'work_order_without_requester_signing'
    tamper = {"params": {"requesterSignature": ""}}
