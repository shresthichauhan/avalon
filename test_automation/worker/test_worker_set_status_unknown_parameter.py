...
def test_worker_set_status_unknown_parameter(setup_config):
    ...
    input_json_file = r'./worker/input/worker_set_status_unknown_parameter.json'
    id_gen = False
    output_json_file_name = 'worker_set_status_unknown_parameter'

    # expected response
    check_worker_result = {"error": {"code": 0}}
