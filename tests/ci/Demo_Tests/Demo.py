    ...
    if input_json_dir:
        ...
        for file in sorted(files):
            try:
                ...
                if response and ("WorkerRegister" not in input_json_str1):
                ...
                LOGGER.exception("Exception occured while processing file: %s,\n Error: %s\n\n", file, e)
            verify_results(input_json_obj, file, response)
