...
def test_work_order_encryptedDataEncryptionKey_hyphen(setup_config):
    """ Request: Testing work order by passing encryptedDataEncryptionKey hyphen in index of indata.
        Response: checking for all required paramters in getresult """
    ...
    input_json_file = './work_order/input/work_order_encryptedDataEncryptionKey_hyphen.json'
    input_type = 'file'
    output_json_file_name = 'work_order_encryptedDataEncryptionKey_hyphen'
    tamper = {"params": {}}
