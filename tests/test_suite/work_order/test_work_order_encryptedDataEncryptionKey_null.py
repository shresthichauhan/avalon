...
def test_work_order_encryptedDataEncryptionKey_null(setup_config):
    """ Request: Testing work order by passing encryptedDataEncryptionKey null in index of indata.
    ...
    input_json_file = './work_order/input/work_order_encryptedDataEncryptionKey_null.json'
    input_type = 'file'
    output_json_file_name = 'work_order_encryptedDataEncryptionKey_null'
    tamper = {"params": {}}
