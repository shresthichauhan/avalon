...
def test_work_order_negative_index(setup_config):
    """ Request: Testing work order by passing negative index in indata.
    ...
    input_json_file = './work_order/input/work_order_negative_index.json'
    input_type = 'file'
    output_json_file_name = 'work_order_negative_index'
    tamper = {"params": {}}
