...
def test_work_order_signature_with_wrong_payload_format(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_signature_with_wrong_payload_format.json'
    input_type = 'file'
    output_json_file_name = 'work_order_signature_with_wrong_payload_format'
    tamper = {"params": {}}
