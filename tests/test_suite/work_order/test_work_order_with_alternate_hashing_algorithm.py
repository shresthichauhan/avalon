...
def test_work_order_with_alternate_hashing_algorithm(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_with_alternate_hashing_algorithm.json'
    input_type = 'file'
    output_json_file_name = 'work_order_with_alternate_hashing_algorithm'
    tamper = {"params": {}}
    ...
    worker_obj.hashingAlgorithm = "SHA-512"
