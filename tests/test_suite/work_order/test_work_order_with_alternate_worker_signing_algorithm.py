...
def test_work_order_with_alternate_worker_signing_algorithm(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_with_alternate_worker_signing_algorithm.json'
    input_type = 'file'
    output_json_file_name = 'work_order_with_alternate_worker_signing_algorithm'
    tamper = {"params": {}}
    ...
    # force alternate valid signing algorithm
