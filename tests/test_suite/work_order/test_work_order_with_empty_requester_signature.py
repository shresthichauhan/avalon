...
def test_work_order_with_empty_requester_signature(setup_config):
    """ Testing work order request with empty requester signature . """
    ...
    input_json_file = r'./work_order/input/work_order_with_empty_requester_signature.json'
    input_type = 'file'
    output_json_file_name = 'work_order_with_empty_requester_signature'
