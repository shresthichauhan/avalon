...
def test_work_order_unknown_parameter_value(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_unknown_parameter_value.json'
    input_type = 'file'
    output_json_file_name = 'work_order_unknown_parameter_value'
    tamper = {"params": {}}
