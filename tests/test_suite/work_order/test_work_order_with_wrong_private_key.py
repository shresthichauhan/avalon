...
def test_work_order_with_wrong_private_key(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_with_wrong_private_key.json'
    input_type = 'file'
    output_json_file_name = 'work_order_with_wrong_private_key'
    tamper = {"params": {}}

    # assign wrong private_key
    private_key = "BA12"
