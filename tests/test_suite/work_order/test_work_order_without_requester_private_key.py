...
def test_work_order_without_requester_private_key(setup_config):
    ...
    input_json_file = r'./work_order/input/work_order_without_requester_private_key.json'
    input_type = 'file'
    output_json_file_name = 'work_order_without_requester_private_key'
    tamper = {"params": {}}

    # reset private key to null
    private_key = ""

    # expected response
    check_submit = {"error": {"code": 5}}
    check_get_result = {"result": {"workOrderId": "Dummy"}}
