...
def test_work_order_workerEncryptionKey_special_character(setup_config):
    ...
    input_json_file = './work_order/input/work_order_workerEncryptionKey_special_character.json'
    input_type = 'file'
    output_json_file_name = 'work_order_workerEncryptionKey_special_character'
    tamper = {"params": {}}
