...
def test_work_order_submit_workload_id_empty_string(setup_config):
    ...
    input_json = './work_order/input/work_order_submit_workload_id_empty_string.json'
    input_type = 'file'
    output_json_file_name = 'work_order_submit_workload_id_empty_string'
    ...
    enc_session_key) = work_order_utility.process_work_order(input_json,
