...
def test_worker_update_unknown_parameter(setup_config):
    """ Testing worker update request with unknown parameter values. """

    # retrieve values from conftest session fixture
    worker_obj, uri_client, private_key, err_cd = setup_config[:4]

    # input and output names
    request = './worker_tests/input/worker_update_unknown_parameter.json'
    request_mode = 'file'
    output_json_file_name = 'worker_update'
    tamper = {"params": {}}
    request_method = ""
...
def test_worker_update_wrong_method_name(setup_config):
    """ Testing worker update request with wrong method name. """

    # retrieve values from conftest session fixture
    worker_obj, uri_client, private_key, err_cd = setup_config[:4]

    # input and output names
    request = './worker_tests/input/worker_wrong_method_name.json'
    request_mode = 'file'
    output_json_file_name = 'worker_update'
    tamper = {"params": {}}
    request_method = ""
...
def test_worker_update_removal_id(setup_config):
    """ Testing worker update request by not passing id param. """

    # retrieve values from conftest session fixture
    worker_obj, uri_client, private_key, err_cd = setup_config[:4]

    # input and output names
    request = './worker_tests/input/worker_update_removal_id.json'
    request_mode = 'file'
    output_json_file_name = 'worker_update'
    tamper = {"params": {}}
    request_method = ""
